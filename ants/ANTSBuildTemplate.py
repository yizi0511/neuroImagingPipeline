...
def ANTSTemplateBuildSingleIterationWF(iterationPhasePrefix=''):
    ...
    BeginANTS.inputs.output_transform_prefix = 'out_'
    BeginANTS.inputs.metric = ['PR']
    ...
    BeginANTS.inputs.number_of_iterations = [30, 20, 20, 5]
   ...
   # BeginANTS.inputs.mi_option = [32, 16000]
    ...
    BeginANTS.inputs.regularization_gradient_field_sigma = 2
